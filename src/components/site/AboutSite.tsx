...
export function AboutSite(){
     return(<>
      <div className="row">
        <div className="col-sm-4">
          <div className="card"> 
            ...
            <div className="card-body">
              <h5 className="card-title">악보나라</h5> <br/> <br/>
              <p className="card-text">피아노 악보, 기타, 베이스, 드럼 등 전문 악보 판매 사이트</p><br/> <br/>
        ...
        <div className="col-sm-4">
        <div className="card">
            <img src="https://play-lh.googleusercontent.com/4KyYCcSW0JxwfmEi_gmXy1U_6_WkauIkaMKIzYAbQJ688VaTuBQFYCyyIyMdsrkZ4g" className="card-img-top" alt="악보바다" style={{width: 200+"px", margin: "0 auto"}}/>
            <div className="card-body">
              <h5 className="card-title">악보바다</h5> <br/> <br/>
              <p className="card-text">피아노 악보, 기타, 베이스, 드럼 등 전문 악보 판매 사이트</p><br/> <br/>
        ...
        <div className="col-sm-4">
          <div className="card">
            ...
            <div className="card-body">
              <h5 className="card-title">유튜브뮤직</h5> <br/> <br/>
              <p className="card-text"> 음악 스트리밍 서비스</p> <br/> 
      ...
      <div className="row">
        <div className="col-sm-4">
          <div className="card">
            ...
            <div className="card-body">
              <h5 className="card-title">멜론</h5> <br/> <br/>
              <p className="card-text">음원판매 및 실시간 차트 확인 라이브 스트리밍</p> <br/> <br/>
        ...
        <div className="col-sm-4">
          <div className="card">
            ...
            <div className="card-body">
              <h5 className="card-title">지니뮤직</h5> <br/> <br/>
              <p className="card-text">음원판매 및 실시간 차트 확인 라이브 스트리밍</p> <br/> <br/>
